...
$(function () {
  ...
  window.funs.setLocation = function (lat, lng) {
    $.ajax ({
      url: 'set.php',
      data: {
        lat: lat,
  ...
  google.maps.event.addDomListener (window, 'load', function () {
    ...
    var zoom = 12;
    var lat  = 25.056678157775092;
    var lng  = 121.53488159179688;

    window.vars.maps = new google.maps.Map (window.vars.$maps.get (0), {
      zoom: zoom, zoomControl: true, scrollwheel: true, scaleControl: true, mapTypeControl: false, navigationControl: true, streetViewControl: false, disableDoubleClickZoom: true,
    ...
    google.maps.event.addListener (window.vars.marker, 'dragend', function (e) {
      ...
      window.funs.setLocation (lat, lng);
    });
